...
CREATE TRIGGER users_updated_at_step1 BEFORE UPDATE ON users FOR EACH ROW EXECUTE PROCEDURE refresh_updated_at_none();
CREATE TRIGGER users_updated_at_step2 BEFORE UPDATE OF updated_at ON users FOR EACH ROW EXECUTE PROCEDURE refresh_updated_at_same();
CREATE TRIGGER users_updated_at_step3 BEFORE UPDATE ON users FOR EACH ROW EXECUTE PROCEDURE refresh_updated_at_current();
...
CREATE TRIGGER user_auth_emails_updated_at_step1 BEFORE UPDATE ON user_auth_emails FOR EACH ROW EXECUTE PROCEDURE refresh_updated_at_none();
CREATE TRIGGER user_auth_emails_updated_at_step2 BEFORE UPDATE OF updated_at ON user_auth_emails FOR EACH ROW EXECUTE PROCEDURE refresh_updated_at_same();
CREATE TRIGGER user_auth_emails_updated_at_step3 BEFORE UPDATE ON user_auth_emails FOR EACH ROW EXECUTE PROCEDURE refresh_updated_at_current();
...
CREATE TRIGGER refresh_tokens_updated_at_step1 BEFORE UPDATE ON refresh_tokens FOR EACH ROW EXECUTE PROCEDURE refresh_updated_at_none();
CREATE TRIGGER refresh_tokens_updated_at_step2 BEFORE UPDATE OF updated_at ON refresh_tokens FOR EACH ROW EXECUTE PROCEDURE refresh_updated_at_same();
CREATE TRIGGER refresh_tokens_updated_at_step3 BEFORE UPDATE ON refresh_tokens FOR EACH ROW EXECUTE PROCEDURE refresh_updated_at_current();
